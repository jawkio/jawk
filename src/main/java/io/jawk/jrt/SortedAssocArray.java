...
/**
 * An AWK associative array backed by a {@link TreeMap}.
 * <p>
 * Keys are maintained in sorted order using AWK comparison semantics: numeric
 * keys are compared numerically, string keys lexicographically, and mixed
 * key types fall back to string comparison.
 * </p>
 *
 * @author MetricsHub
 */
public class SortedAssocArray extends TreeMap<Object, Object> implements AssocArray {
	...
	/**
	 * AWK-specific key comparator: numeric keys are compared numerically; mixed or
	 * string keys fall back to lexicographic string comparison.
	 */
	private static final Comparator<Object> AWK_COMPARATOR = (o1, o2) -> {
	...
	/**
	 * Returns the specification version of the underlying {@link TreeMap} class.
	 *
	 * @return the specification version string, or {@code null} if unavailable
	 */
	@Override
	public String getMapVersion() {
		return TreeMap.class.getPackage().getSpecificationVersion();
	}
	 ...
	 *         {@link TreeMap#toString()} in an AWK evaluation
	 *         context
	 */
	@Override
